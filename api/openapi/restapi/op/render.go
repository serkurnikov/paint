...
type RenderHandlerFunc func(RenderParams, interface{}) RenderResponder

// Handle executing the request and returning a response
func (fn RenderHandlerFunc) Handle(params RenderParams, principal interface{}) RenderResponder {
	return fn(params, principal)
}

// RenderHandler interface for that can handle valid render params
type RenderHandler interface {
	Handle(RenderParams, interface{}) RenderResponder
}
